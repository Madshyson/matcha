...
app.controller('mainController', ['$scope','$rootScope','$http','$cookies', '$sce', function($scope, $rootScope, $http, $cookies, $sce) {
    ...
    deco.onclick = function () {
        ...
        setTimeout(function(){window.location.replace("http://46.101.26.198/#/login")}, 100);
    };
}]);
...
app.controller('createController', function($scope, $http) {
    function requete_api() {
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/create',
            data: {
                mail: $scope.mail,
                pseudo: $scope.pseudo,
            ...
            if (response.data.state == 'success') {
                ...
                setTimeout(function(){window.location.replace("http://46.101.26.198/#/login")}, 1500);
            }
...
app.controller('loginController', ['$scope', '$http','$cookies', function($scope, $http, $cookies) {
    function requete_api() {
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/login',
            data: {
                pseudo: $scope.pseudo,
                password: $scope.password
            }
            ...
            if (response.data.state == 'success') {
                ...
                setTimeout(function(){window.location.replace("http://46.101.26.198/#/my_account")}, 1500);
            }
            else if (response.data.state == 'validation') {
                $scope.validation = response.data.json;
            }
    ...
    function reset_password() {
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/reset',
            data: {
                mail: $scope.mail,
                pseudo: $scope.pseudo
            }
...
app.controller('accountController', ['$scope', '$http','$cookies', function($scope, $http, $cookies) {
    function requete_api() {
        ...
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/myaccount',
            data: data
        }).then(function successCallback(response) {
            var toHide = document.getElementsByClassName("hidden");
            for (var i = 0; i < toHide.length; ++i) {toHide[i].style.display = "none";}
    ...
    function delete_notifs() {
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/deletenotifs',
            data: {
...
app.controller('searchController', ['$scope', '$http','$cookies', function($scope, $http, $cookies) {
    ...
    function requete_api() {
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/users',
            data: {
                token : $cookies.get('myTokenCode'),
...
app.controller('userController', ['$scope', '$http','$cookies', function($scope, $http, $cookies) {
    function requete_api() {
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/useraccount',
            data: {
                token: $cookies.get('myTokenCode'),
                pseudo: Pseudo
            }
    ...
    function likeIt() {
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/userlike',
            data: {
                token: $cookies.get('myTokenCode'),
                pseudo: Pseudo
            }
    ...
    function reportIt() {
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/userreport',
            data: {
                token: $cookies.get('myTokenCode'),
                pseudo: Pseudo
            }
    ...
    function blockIt() {
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/userblock',
            data: {
                token: $cookies.get('myTokenCode'),
                pseudo: Pseudo
            }
...
app.controller('chatController', ['$scope', '$http','$cookies', function($scope, $http, $cookies) {
    function requete_api() {
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/chathisto',
            data: {
                token: $cookies.get('myTokenCode'),
                pseudo: Pseudo
            }
    ...
    function chatIt() {
        $http({
            method: 'POST',
            url: 'http://46.101.26.198:4201/userchat',
            data: {
                token: $cookies.get('myTokenCode'),
                pseudo: Pseudo,
